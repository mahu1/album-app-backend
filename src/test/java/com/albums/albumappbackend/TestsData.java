...
public class TestsData {
    ...
    public static AlbumDto getAlbum1() {
        AlbumDto albumDto1 = new AlbumDto(1L, "Iron & Wine", new ArtistDto(1L, "Iron & Wine"), "https://m.media-amazon.com/images/I/61Xzf+RI9sL._AC_.jpg", LocalDate.of(2004, 3, 23).toString(), new HashSet<>());
    ...
    public static AlbumDto getAlbum2() {
        AlbumDto albumDto2 = new AlbumDto(2L, "Abbey Road", new ArtistDto(2L,"The Beatles"), "https://m.media-amazon.com/images/I/A19M5TR8iYL._AC_SX679_.jpg", LocalDate.of(1969, 9, 26).toString(), new HashSet<>());
